...
segment_start1, segment_end1 = geometry.randn_line_segment(random_state)
...
for i in range(50000):
    segment_start2, segment_end2 = geometry.randn_line_segment(random_state)
    ...
    print(dist)
    if i > 15: continue
    plotting.plot_segment(ax, contact_point_segment1, contact_point_segment2)
