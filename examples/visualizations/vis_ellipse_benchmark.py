...
from distance3d.random import rand_ellipse
from distance3d.colliders import Ellipse
...
timer = Timer()
capsule_frames = list(range(1000))
fast_transform_manager_initialization(tm, capsule_frames, "base")
for i in capsule_frames:
    center, axes, radii = rand_ellipse(random_state, radii_scale=0.3)
    collider = Ellipse(center, axes, radii)
