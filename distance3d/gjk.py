...
def _distance_subalgorithm_face(simplex, d):
    solution = Solution()
    _compute_face_distances_0(simplex, d.d2, d.d3)
    vertex_1_optimal = not (d.d2[2] > 0.0 or d.d3[4] > 0.0)
    if vertex_1_optimal:
        simplex.reduce_to_optimal_vertex(0)
        solution.from_vertex(simplex, 0, d.d1[0])
        return solution
    _compute_face_distances_1(simplex, d.d1, d.d2, d.d3)
    line_segment_12_optimal = not (d.d1[2] <= 0.0 or d.d2[2] <= 0.0 or d.d3[6] > 0.0)
    if line_segment_12_optimal:
        simplex.n_simplex_points = 2
        solution.from_line_segment(simplex, 1, 0, d.d1[2], d.d2[2])
        return solution
    e123 = _compute_face_distances_2(simplex, d.d1, d.d2, d.d3)
    ...
    if line_segment_13_optimal:
        ...
        return solution
    _compute_face_distances_3(simplex, d.d1, d.d2, d.d3, e123)
...
def _distance_subalgorithm_simplex(simplex, d):
    ...
    if face_123_optimal:
        ...
        solution.from_face(simplex, 2, 0, 1, d.d1[6], d.d2[6], d.d3[6])
        return solution
    e124, e134 = _compute_simplex_distances_0(simplex, d.d1, d.d2, d.d3, d.d4)
    ...
    if line_segment_14_optimal:
        ...
        return solution
    e214 = _compute_simplex_distances_1(simplex, d.d1, d.d2, d.d3, d.d4, e124, e132, e134)
    ...
    if face_124_optimal:
        ...
        return solution
    _compute_simplex_distances_2(simplex, d.d1, d.d2, d.d3, d.d4, e123, e124, e134)
    ...
    if face_134_optimal:
        ...
        return solution
    _compute_simplex_distances_3(simplex, d.d1, d.d2, d.d3, d.d4, e213, e214)
...
def _backup_procedure(simplex, solution, d, backup):
    ...
    solution_d = Solution()
    if len(simplex) == 1:
        solution.from_vertex(simplex, 0, d1[0])
...
def _backup_procedure_line_segment(
    ...
    if check_line_segment_12:
        solution_d.from_line_segment(simplex, 1, 0, d1[2], d2[2])
    ...
    if check_vertex_2:
        n_simplex_points = 1
        solution.from_vertex(simplex, 1, d2[1])
        ordered_indices[0] = 1
...
def _backup_procedure_face(
    ...
    if check_line_segment_13:
        solution_d.from_line_segment(simplex, 2, 0, d1[4], d3[4])
        if solution_d.dstsq < solution.dstsq:
            n_simplex_points = 2
            solution.copy_from(solution_d, n_simplex_points)
    ...
    if check_face_123:
        solution_d.from_face(simplex, 2, 0, 1, d1[6], d2[6], d3[6])
        if solution_d.dstsq < solution.dstsq:
            n_simplex_points = 3
            solution.copy_from(solution_d, n_simplex_points)
    ...
    if check_vertex_3:
        n_simplex_points = 1
        solution.from_vertex(simplex, 2, d3[3])
        ordered_indices[0] = 2
    check_line_segment_23 = not (d2[5] <= 0.0 or d3[5] <= 0.0)
    if check_line_segment_23:
        solution_d.from_line_segment(simplex, 2, 1, d2[5], d3[5], 1, 0)
        if solution_d.dstsq < solution.dstsq:
            n_simplex_points = 2
            solution.copy_from(solution_d, n_simplex_points)
...
def _backup_procedure_simplex(
    ...
    if check_line_segment_14:
        solution_d.from_line_segment(simplex, 3, 0, d1[8], d4[8])
        if solution_d.dstsq < solution.dstsq:
            n_simplex_points = 2
            solution.copy_from(solution_d, n_simplex_points)
    ...
    if check_face_124:
        solution_d.from_face(simplex, 3, 0, 1, d1[11], d2[11], d4[11])
        if solution_d.dstsq < solution.dstsq:
            n_simplex_points = 3
            solution.copy_from(solution_d, n_simplex_points)
    ...
    if check_face_134:
        solution_d.from_face(simplex, 3, 0, 2, d1[12], d3[12], d4[12], 0, 2, 1)
        if solution_d.dstsq < solution.dstsq:
            n_simplex_points = 3
            solution.copy_from(solution_d, n_simplex_points)
    ...
    if check_convex_hull:
        solution_d.from_simplex(simplex, d1[14], d2[14], d3[14], d4[14])
        if solution_d.dstsq < solution.dstsq:
            n_simplex_points = 4
            solution.copy_from(solution_d, n_simplex_points)
    ...
    if check_vertex_4:
        n_simplex_points = 1
        solution.from_vertex(simplex, 3, d4[7])
        ordered_indices[0] = 3
    check_line_segment_23 = not (d2[5] <= 0.0 or d3[5] <= 0.0)
    if check_line_segment_23:
        solution_d.from_line_segment(simplex, 1, 2, d2[5], d3[5], 1, 0)
        if solution_d.dstsq < solution.dstsq:
            n_simplex_points = 2
            solution.copy_from(solution_d, n_simplex_points)
            ordered_indices[:2] = 2, 1
    ...
    if check_line_segment_24:
        solution_d.from_line_segment(simplex, 3, 1, d2[9], d4[9], 1, 0)
        if solution_d.dstsq < solution.dstsq:
            n_simplex_points = 2
            solution.copy_from(solution_d, n_simplex_points)
    ...
    if check_line_segment_34:
        solution_d.from_line_segment(simplex, 3, 2, d3[10], d4[10])
        if solution_d.dstsq < solution.dstsq:
            n_simplex_points = 2
            solution.copy_from(solution_d, n_simplex_points)
    ...
    if check_face_234:
        solution_d.from_face(simplex, 3, 1, 2, d2[13], d3[13], d4[13], 1, 2, 0)
        if solution_d.dstsq < solution.dstsq:
            n_simplex_points = 3
            solution.copy_from(solution_d, n_simplex_points)
