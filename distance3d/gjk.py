...
class Simplex:
    ...
    def search_direction_line(self, vertex_index_1, vertex_index_2, a):
        return self.simplex[vertex_index_1] + a * (
            self.simplex[vertex_index_2] - self.simplex[vertex_index_1])
